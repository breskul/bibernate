...
/**
 * <h3>{@link EntityNode} provides an abstraction for entity. In case parent entity has collection field {@link OneToMany}, it is easier to think of it as a tree with parent node and childes nodes  </h3>
